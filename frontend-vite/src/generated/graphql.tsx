...
export type BookmarkCreateMutation = {
  __typename?: 'Mutation';
  bookmarkCreate: {
    __typename?: 'Bookmark';
    pk?: string | null;
...
export type BookmarkDeleteMutation = {
  __typename?: 'Mutation';
...
export type BookmarkUpdateMutation = {
  __typename?: 'Mutation';
  bookmarkUpdate: {
    __typename?: 'Bookmark';
    pk?: string | null;
...
export type NetscapeImportMutation = {
  __typename?: 'Mutation';
  netscapeImport: string;
};
...
export function useBookmarkCreateMutation() {
  return Urql.useMutation<
    ...
    BookmarkCreateMutationVariables
...
export function useBookmarkDeleteMutation() {
  return Urql.useMutation<
    ...
    BookmarkDeleteMutationVariables
  >(BookmarkDeleteDocument);
}
...
export function useBookmarkListQuery(
  options?: Omit<Urql.UseQueryArgs<BookmarkListQueryVariables>, 'query'>
) {
  return Urql.useQuery<BookmarkListQuery>({
    query: BookmarkListDocument,
    ...options,
  });
}
...
export function useBookmarkUpdateMutation() {
  return Urql.useMutation<
    ...
    BookmarkUpdateMutationVariables
...
export function useCategoryListQuery(
  options?: Omit<Urql.UseQueryArgs<CategoryListQueryVariables>, 'query'>
) {
  return Urql.useQuery<CategoryListQuery>({
...
export function useNetscapeImportMutation() {
  return Urql.useMutation<
    NetscapeImportMutation,
    NetscapeImportMutationVariables
  >(NetscapeImportDocument);
}
